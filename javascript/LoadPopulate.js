...
function Populate() {
  ...
  if (populateOnce == null) {
    ...
    addBug = {
      ...
      ProjectPriority: ProjectNewPriority,
    ...
    addProjectLoad = {
      ...
      ProjectDescription: ProjectNewDescription,
      ProjectType: ProjectNewType,
    ...
    ProjectNewDescription =
      "Ensure all functions are accessible by button onclicks";
    ProjectNewType = "Project";
    addProjectLoad = {
      ProjectID: ProjectNewID,
      ProjectPriority: ProjectNewPriority,
    ...
    try {
      ...
      if (currentType == "Project") {
        ...
        document.getElementById("ProjectList").innerHTML +=
          "<div class='projectIDhover' onclick='showProject(" +
          currentOBJ.ProjectID +
          ")'>" +
          currentOBJ.ProjectID +
          "</div>" +
          "<div>" +
          currentOBJ.ProjectName +
          "</div>" +
          "<div>" +
          currentOBJ.ProjectDescription +
          "</div><div> <button onclick='DeleteProject(" +
          currentOBJ.ProjectID +
          ")'>Delete Project " +
          currentOBJ.ProjectID +
          " </button> </div>";
        ...
        document.getElementById("EmployeeList").innerHTML +=
          "<div class='table-header projectIDhover' onclick='editEmployee(" +
        ...
        document.getElementById("EmployeeList").innerHTML +=
          ...
          currentOBJ.EmployeeFirstName +
          "</h4></div>";
        document.getElementById("EmployeeList").innerHTML +=
          "<div class='table-header'><h4>" +
          currentOBJ.EmployeeLastName +
          "</h4></div>";
        document.getElementById("EmployeeList").innerHTML +=
          "<div class='table-header'><h4>" +
          currentOBJ.EmployeeEmail +
          "</h4></div>";
        document.getElementById("EmployeeList").innerHTML +=
          "<div class='table-header'><h4>" +
          currentOBJ.EmployeeUsername +
          "</h4></div>";
        document.getElementById("EmployeeList").innerHTML +=
          "<div class='table-header'><h4></h4></div>";
      } else if (currentType == "Bug") {
        document.getElementById("bugListWrapper").innerHTML +=
          "<div class='table-header projectIDhover' onclick='ShowBugPage(" +
          currentOBJ.BugId +
          ")'><h4>" +
          currentOBJ.BugId +
          "</h4></div>";
